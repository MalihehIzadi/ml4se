...
|:------:|:---:|:------:|---------------------------------|----------|
|  5/9   | 1 | 1  | [Course Introduction](course-intro.html), [How to read a paper in a group](discussing-papers.html), [DeepBugs](https://arxiv.org/abs/1805.11683) | Georgios |
|  7/9   | 1 | 2  | [Recent work on Correctness of Code generated by LLMs](https://arxiv.org/abs/2303.11455) | Prem Devanbu (UC Davis)|
